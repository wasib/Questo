...
public class Edit_My_Profile extends AppCompatActivity {
    ...
    public void edit() {
        ...
        if (!(editname.getText().toString().trim().length() == 0) && !(editemail.getText().toString().trim().length() == 0) && isEmailValid(editemail.getText().toString().trim())) {
            ...
            if (editemail != null && !editemail.getText().toString().equals("")) {
