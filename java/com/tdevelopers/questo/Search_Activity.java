...
import com.tdevelopers.questo.SearchFragments.ArticleSearch;
                ...
                mpager.setAdapter(new FragmentStatePagerAdapter(getSupportFragmentManager()) {
                    ...
                    public Fragment getItem(int position) {
                        switch (position % 6) {
                            ...
                            case 3:
                                ArticleSearch.setQuery(data + "");
                                return ArticleSearch.newInstance();
                            case 5:
                            ...
                            public void onTabReselected(TabLayout.Tab tab) {
                                ...
                                switch (numTab) {
                                    ...
                                    case 3:
                                        ...
                                        recyclerView = (RecyclerView) findViewById(R.id.searcharticlerv);
