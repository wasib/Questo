...
// add FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS flag to the window
        ...
        if (id != null && id.trim().length() != 0 && id.equals(Profile.getCurrentProfile().getId()) && AccessToken.getCurrentAccessToken() != null && !AccessToken.getCurrentAccessToken().isExpired()) {
                ...
                mpager.setAdapter(new FragmentStatePagerAdapter(getSupportFragmentManager()) {
                    ...
                    public Fragment getItem(int position) {
                        switch (position % 6) {
                            ...
                            case 1:
                                return UserQuestions.newInstance(id);
                            case 2:
                                return UserArticles.newInstance(id);
                            ...
                            public void onTabReselected(TabLayout.Tab tab) {
                                ...
                                switch (numTab) {
                                    ...
                                    case 2:
                                        ...
                                        ns = (NestedScrollView) findViewById(R.id.ns1);
                                        if (ns != null) {
                                            ns.smoothScrollTo(0, 0);
                                        }
                                        break;
                                    ...
                                    case 4:
                                        ...
                                        ns = (NestedScrollView) findViewById(R.id.ns3);
                                        if (ns != null) {
                                            ns.smoothScrollTo(0, 0);
                                        }
                                        break;
                                    case 5:
                                        ...
                                        ns = (NestedScrollView) findViewById(R.id.ns4);
                                        if (ns != null) {
                                            ns.smoothScrollTo(0, 0);
                                        }
                                        break;
...
//                holder.subtext.setText(t.followers.size() + " followers | " + t.following.size() + " following");
                            ...
                            if (current.id.equals(Profile.getCurrentProfile().getId())) {
                            ...
                            if (!current.id.equals(Profile.getCurrentProfile().getId())) {
                                ...
                                if (current.followers != null && current.followers.containsKey(Profile.getCurrentProfile().getId()))
