    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        if (data != null) {
            ...
            FirebaseDatabase.getInstance().getReference("Question").child(data.get(position % data.size())).child("likes_count").addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot != null && dataSnapshot.getValue() != null)
                        holder.likecount.setText(dataSnapshot.getValue().toString());
                }
            ...
            FirebaseDatabase.getInstance().getReference("Question").child(data.get(position % data.size())).child("comment_count").addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot != null && dataSnapshot.getValue() != null)
                        holder.commentcount.setText(dataSnapshot.getValue().toString());
                }
