...
public class Question {
    ...
    public Long date;
    public Long viewcount, comment_count, correct_count, wrong_count;


    public Question(String id, Long date, String username, String question, String explanation, String choice0, String choice1, String choice2, String choice3, Integer answer, String uploaded_by) {
        this.uploaded_by = uploaded_by;
        this.date = date;
        this.correct_count = 0L;
        this.wrong_count = 0L;
        this.viewcount = 0L;
        this.nlikes_count = 0L;
