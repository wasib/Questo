 ...
 */
public class MostLiked extends Fragment {
    ...
    public static MostLiked newInstance() {
        Bundle args = new Bundle();
        MostLiked fragment = new MostLiked();
    ...
    public static void FilterLoadData() {
       // avl.setVisibility(View.VISIBLE);
        ...
        FirebaseDatabase.getInstance().getReference("Question").orderByChild("nlikes_count").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                                     @Override
    ...
    public static void LoadData()   {
        final Query q = FirebaseDatabase.getInstance().getReference("Question").orderByChild("nlikes_count").limitToFirst(10);
                    ...
                    if (dataSnapshot != null && dataSnapshot.getValue() != null && dataSnapshot.getChildren() != null) {
                        ...
                        recyclerView.addOnScrollListener(new EndlessRecyclerViewScrollListener(l) {
                            ...
                            public void onLoadMore(int page, int totalItemsCount) {
                                final Query extra = FirebaseDatabase.getInstance().getReference("Question").orderByChild("nlikes_count").limitToFirst(totalItemsCount + 5);
